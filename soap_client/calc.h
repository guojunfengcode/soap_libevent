...
/* calc.h
   Generated by wsdl2h 2.8.95 from http://www.genivia.com/calc.wsdl and typemap.dat
   2019-12-13 02:58:21 GMT
...
int ns2__add(
    char                                *bookname,	///< Input parameter, :unqualified name as per RPC encoding
    char                                *bookkind,	///< Input parameter, :unqualified name as per RPC encoding
    char                                *bookprice,	///< Input parameter, :unqualified name as per RPC encoding
...
int ns2__mod(
    int                               hashvalue,	///< Input parameter, :unqualified name as per RPC encoding
    char                              *mod_name,	///< Input parameter, :unqualified name as per RPC encoding
    char                              *mod_later_name,
    char                              **result	///< Output parameter, :unqualified name as per RPC encoding
);
